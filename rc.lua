...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "r",     function () awful.spawn('ulauncher') end,
              {description = "run prompt", group = "launcher"}),

    -- Lock screen
    awful.key({modkey}, "l", function () awful.spawn('gnome-screensaver-command --lock') end,
